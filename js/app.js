...
function calcular () {
  ...
  if (option === '1'){
    ...
    if (isNaN(btc) || btc<= 0) {
      ...
      alert(`Hola ${nombre}, tus ${btc} BTC equivalen a $${formatearDecimal(pesos)}`);
    }
  } else if (option === '2') {
      ...
      if (isNaN(pesos) || pesos <=0){
        ...
        alert(`${nombre} la cantidad de Bitcoins que puedes comprar con tus $${formatearDecimal(pesos)} es de ${bitcoin} BTC`); 
      }
    } else {
